...
- **Architecture**: RESTful APIs, Microservices, Multi-tenant Systems, Clean Architecture, SOLID, Design Patterns
- **Testing**: PHPUnit, Feature & Unit Testing, Code Review, Static Analysis
